...
## Worker Identity
- Team: openclaw-clawdbot-exec-routing
- Worker: worker-1
- Role: executor
- Leader cwd: /Users/jangjiho/workspace/pressco21-worktrees/workspace-openclaw-setup-audit
- Worktree root: /Users/jangjiho/workspace/pressco21-worktrees/workspace-openclaw-setup-audit/.omx/team/openclaw-clawdbot-exec-routing/worktrees/worker-1
- Team state root: /Users/jangjiho/workspace/pressco21-worktrees/workspace-openclaw-setup-audit/.omx/state
- Inbox path: /Users/jangjiho/workspace/pressco21-worktrees/workspace-openclaw-setup-audit/.omx/state/team/openclaw-clawdbot-exec-routing/workers/worker-1/inbox.md
- Mailbox path: /Users/jangjiho/workspace/pressco21-worktrees/workspace-openclaw-setup-audit/.omx/state/team/openclaw-clawdbot-exec-routing/mailbox/worker-1.json
- Leader mailbox path: /Users/jangjiho/workspace/pressco21-worktrees/workspace-openclaw-setup-audit/.omx/state/team/openclaw-clawdbot-exec-routing/mailbox/leader-fixed.json
- Task directory: /Users/jangjiho/workspace/pressco21-worktrees/workspace-openclaw-setup-audit/.omx/state/team/openclaw-clawdbot-exec-routing/tasks
- Worker status path: /Users/jangjiho/workspace/pressco21-worktrees/workspace-openclaw-setup-audit/.omx/state/team/openclaw-clawdbot-exec-routing/workers/worker-1/status.json
- Worker identity path: /Users/jangjiho/workspace/pressco21-worktrees/workspace-openclaw-setup-audit/.omx/state/team/openclaw-clawdbot-exec-routing/workers/worker-1/identity.json

## Protocol
1. Read your inbox at `/Users/jangjiho/workspace/pressco21-worktrees/workspace-openclaw-setup-audit/.omx/state/team/openclaw-clawdbot-exec-routing/workers/worker-1/inbox.md`.
2. Load the worker skill from the first existing path:
   - `${CODEX_HOME:-~/.codex}/skills/worker/SKILL.md`
   - `/Users/jangjiho/workspace/pressco21-worktrees/workspace-openclaw-setup-audit/.codex/skills/worker/SKILL.md`
   - `/Users/jangjiho/workspace/pressco21-worktrees/workspace-openclaw-setup-audit/skills/worker/SKILL.md`
3. Send startup ACK before task work:

   `omx team api send-message --input "{"team_name":"openclaw-clawdbot-exec-routing","from_worker":"worker-1","to_worker":"leader-fixed","body":"ACK: worker-1 initialized"}" --json`
...
5. Read task files from `/Users/jangjiho/workspace/pressco21-worktrees/workspace-openclaw-setup-audit/.omx/state/team/openclaw-clawdbot-exec-routing/tasks/task-<id>.json` using bare `task_id` values in APIs.
...
7. Use mailbox delivery flow:
   - `omx team api mailbox-list --input "{"team_name":"openclaw-clawdbot-exec-routing","worker":"worker-1"}" --json`
   - `omx team api mailbox-mark-delivered --input "{"team_name":"openclaw-clawdbot-exec-routing","worker":"worker-1","message_id":"<MESSAGE_ID>"}" --json`
