...
- Current Owner: IDLE
- Mode: —
- Started At: 2026-03-29 21:50:00 KST
- Branch: main
- Working Scope: 로그인/미리보기 중복 UI, Safari 견적서 분리, 명세표 구분/기본값, 날짜 필터 회귀 보정
...
## Next Step
- 명세표 작성 다이얼로그의 저장/인쇄 액션 버튼 위계를 실제 사용 빈도 기준으로 한 번 더 정리할지 검토한다.
