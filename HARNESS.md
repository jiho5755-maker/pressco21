...
pressco21/CLAUDE.md                  ← 프로젝트 설정 (에이전트 조직도)
    |
pressco21/AI_SYNC.md                 ← 운영 보드 (Claude Code + Codex 공유)
```
...
| pre-push hook | `git push` | AI_SYNC.md 충돌 경고 |
...
| 루프 | 주기 | 담당 |
|------|------|------|
| AI_SYNC.md 아카이빙 | 2주 | 대표 (`bash _tools/archive-ai-sync.sh`) |
...
| `pressco21/AI_SYNC.md` | 운영 보드 | Claude Code + Codex |
...
| `pressco21/_tools/git-hooks/pre-push` | AI_SYNC 충돌 경고 | 대표 + CTO |
| `pressco21/_tools/install-hooks.sh` | Git hook 설치 스크립트 | 대표 + CTO |
| `pressco21/_tools/archive-ai-sync.sh` | AI_SYNC 아카이빙 | 대표 |
...
| 주기 | 작업 | 담당 | 도구 |
|------|------|------|------|
| **2주** | AI_SYNC.md 아카이빙 | 대표 | `bash _tools/archive-ai-sync.sh` |
