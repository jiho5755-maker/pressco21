...
p21_allowed_paths_print() {
  case "$1" in
    ...
    homepage)
      ...
      ;;
    workspace)
      printf '%s\n' 'AGENTS.md' '*/AGENTS.md' 'CLAUDE.md' 'README.md' 'OPS_STATE.md' 'HARNESS.md' 'ROADMAP.md' '.gitignore' '.codex/' '.claude/' '_tools/' 'docs/' 'archive/' 'tools/' 'AI_SYNC.md' 'team/handoffs/'
      ;;
    team)
...
p21_sparse_paths_print() {
  ...
  case "$1" in
    ...
    homepage)
      ...
      ;;
    workspace)
      printf '%s\n' '/README.md' '/OPS_STATE.md' '/HARNESS.md' '/ROADMAP.md' '/.codex/' '/.claude/' '/docs/' '/archive/' '/tools/' '/team/handoffs/'
      ;;
    team)
      printf '%s\n' '/team/' '/company-knowledge/직원/' '/docs/openmarket-ops/' '/docs/prd-templates/' '/AI_SYNC.md'
      ;;
...
p21_is_path_allowed() {
  ...
  case "$project" in
    ...
    homepage)
      ...
      ;;
    workspace)
      case "$path" in AGENTS.md|*/AGENTS.md|CLAUDE.md|README.md|OPS_STATE.md|HARNESS.md|ROADMAP.md|.gitignore|AI_SYNC.md|.codex|.codex/*|.claude|.claude/*|_tools|_tools/*|docs|docs/*|archive|archive/*|tools|tools/*|team/handoffs|team/handoffs/*) return 0 ;; esac
      ;;
    team)
