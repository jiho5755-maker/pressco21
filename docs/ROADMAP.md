...
- **Task 211: WF-01~03 클래스 조회 + 파트너 인증 API 워크플로우** - ✅ JSON 완료 (2026-02-25, 배포 대기)
...
- **Task 212: WF-04 예약 기록 + 수수료 계산 + 정산 파이프라인** - ✅ JSON 완료 (2026-02-25, 배포 대기)
...
- **Task 213: WF-05 주문 폴링 + 야간 배치 (동기화/정합성/재시도/D+3 정산)** - ✅ JSON 완료 (2026-02-25, 배포 대기)
...
- **Task 221: WF-07~08 파트너 신청/승인 + 텔레그램 알림** - ✅ JSON 완료 (2026-02-25, 배포 대기)
...
- **Task 222: WF-06, WF-09~10 클래스 관리 + 후기 답변 + 교육 인증** - ✅ JSON 완료 (2026-02-25, 배포 대기)
...
- **Task 223: WF-13 등급 자동 업데이트 (뼈대 구현)** - ✅ JSON 완료 (2026-02-25, 배포 대기)
...
- **Task 231: WF-11~12 리마인더 + 후기 요청 이메일 자동화** - ✅ JSON 완료 (2026-02-25, 배포 대기)
...
- **Task 232: 텔레그램 알림 통합 (신청/예약/정산/에러)** - ✅ JSON 완료 (2026-02-25, 배포 대기)
