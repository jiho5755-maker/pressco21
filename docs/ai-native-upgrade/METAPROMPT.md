...
| 이재혁 과장 | `8312726947` | ko | HR-001 파일럿 후보, [F22] TG-ROUTER whitelist (2026-04-15 확보) |
...
## 9. ★ 진행 상태 (2026-04-15 기준) — v2.0 신설

| Phase | 단계 | 상태 | 완료일 | 비고 |
|------|------|------|--------|-----|
| P0 | 진단·고정 | 대기 | — | v2.0 재작성 시점 §3 실측 유효 |
| **P1 Wave 1** | 준비 & 인벤토리 | ✅ **완료** | 2026-04-14 | n8n 전수 덤프(142개), 봇 5·그룹 5 실측, T3 `-5251214343`, 원장님 `8606163783`, B3 웹훅 삭제, `Pressco21 개인` |
| **P1 Wave 2** | B3 개인 알림 확장 | ✅ **완료** | 2026-04-14 | INFRA 3 WF 재배선 + Sanity check. 2차 수동 검증(2026-04-15) B3 sendMessage `message_id=1652`, `from="Pressco21 개인"` API 노출 확인 |
