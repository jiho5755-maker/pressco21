<!-- AI-NATIVE-P1 | v2.1 | 2026-04-14 | Claude Opus 4.6 | 장지호 대표 지시 -->
# P1 — 텔레그램 봇·톡방 재편 실행 프롬프트

> **파일 역할**: AI Native 프로젝트의 Phase P1(텔레그램 봇 정리) 실행 지침서
> **상위**: `METAPROMPT.md` v2.0 §11 (P1은 이 문서로 정식 위임)
> **실측 산출물**: `P1-bot-wf-matrix.md` v1.2 (봇·WF 전수 매핑)
> **버전**: **v2.1** (2026-04-14) — Wave 1·2 완료 상태 반영 + 이름 "AI Native" 정식 채택
> **이전 버전**: v2.0 (2026-04-14, ANU 명칭 유지 + Wave 1 80%) / v1.0 (2026-04-13, 스크린샷 기반 초안, 봇 3개 가정)
