...
브랜드 메타포: **"한 송이 꽃이 정원이 되기까지"** (씨앗 → 뿌리 → 꽃밭 → 정원사)

| 등급 | 한글명 | 메타포 | 자격 조건 | 핵심 혜택 | 배지 색상 |
|------|--------|--------|----------|----------|---------|
| 회원 | 일반회원 | 씨앗 Seed | 회원가입 | 정가 구매 | `#a8b5a0` 연한 세이지 |
| 인스트럭터 | 강사회원 | 뿌리 Root | 일반 자격증/수료증 OR 원예 관련 사업자등록증 | 5~10% 할인, 1개 소매도 무조건 적용 | `#7d9675` 브랜드 그린 |
| 파트너스 | 제휴 회원 | 꽃밭 Bloom | 제휴 협회/업체 소속 OR 프레스코21 인정 자격증 | 10~20% 할인, 1개 소매도 무조건 적용 | `#5e8a6e` 딥 그린 |
| VIP | 최고 등급 | 정원사 Gardener | 프레스코21 직접 선정 (주로 협회장) | 특가 + 분기 인센티브 적립금 + 협회 행사 지원 + 전담 1:1 상담 | `#b89b5e` 골드 |

**특별 칭호 (성장 경로와 독립, 어떤 등급이든 병행 가능)**

| 칭호 | 메타포 | 자격 조건 | 핵심 혜택 | 배지 색상 |
|------|--------|----------|----------|---------|
| 엠버서더 | 별빛 Starlight | 바이럴 능력 보유 판단 시 초청 | 신제품 협찬 + 전 제품 30% 할인 + 전용 할인코드 | `#8b6fae` 소프트 퍼플 |
