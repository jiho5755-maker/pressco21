...
(function() {
    ...
    function pc21MatchesPolicyPrice(currentPrice, currentBase, policy) {
        if (!policy || !currentPrice) {
            return false;
        }
        if (currentPrice === policy.member || currentPrice === policy.base) {
            return true;
        }
        if (currentBase && (currentBase === policy.member || currentBase === policy.base)) {
            return true;
        }
        return false;
    }
    ...
    function pc21ApplyMemberPolicyFallback() {
        ...
        if (!pc21MatchesPolicyPrice(salePrice, basePrice, policy)) {
            return;
        }
