...
const ESTIMATE_CSS = [
  ...
  '* { box-sizing:border-box; }',
  '.est-page { width:190mm; page-break-after:always; break-inside:avoid-page; page-break-inside:avoid; }',
  '.est-page:last-child { page-break-after:auto; }',
  '.est-shell { border:1px solid #9ca3af; padding:5.5mm 6mm 5mm; display:flex; flex-direction:column; }',
  ...
  '.est-meta div { display:flex; justify-content:space-between; padding:3px 5px; border-bottom:1px solid #d1d5db; }',
  ...
  '.est-party-table { margin-bottom:6px; }',
  ...
  '.est-footer { padding-top:6px; }',
  '.est-bottom { display:grid; grid-template-columns: 1fr 170px; gap:10px; }',
  '.est-note-block { border:1px solid #9ca3af; min-height:60px; }',
  ...
  '.est-signature { margin-top:6px; display:flex; justify-content:space-between; align-items:flex-end; font-size:8pt; }',
